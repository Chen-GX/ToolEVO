...
EMBED_MODEL_NAME = "/<YOUR_OWN_PATH>/model_cache/all-mpnet-base-v2"
CHROMA_PERSIST_DIRECTORY = "/<YOUR_OWN_PATH>/ToolQA-D/data/chroma_db/agenda"
CHROMA_COLLECTION_NAME = "all"
CHROMA_SERVER_HOST = ""
CHROMA_SERVER_HTTP_PORT = ""
FILE_PATH = "/<YOUR_OWN_PATH>/ToolQA-D/data/external_corpus/agenda/agenda_descriptions_merged.jsonl"
